...
const PostMapContainer: React.FC = React.memo(() => {
  ...
  return (
    <PostMapPresentation posts={state.posts} defaultCenter={state.mapCenter} defaultZoom={13} />
  );
});
...
const PostMapPresentation: React.FC<PostMapPresentationProps> = React.memo((props) => {
